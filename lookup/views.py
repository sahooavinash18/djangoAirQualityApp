...
#https://www.airnowapi.org/aq/forecast/zipCode/?format=application/json&zipCode=94404&date=2020-11-07&distance=5&API_KEY=1B17AB8C-8D34-4905-88E3-577114AB2097
def home(request):
	import json
	import requests
	...
	if request.method == "POST":
		...
		api_request = requests.get("https://www.airnowapi.org/aq/forecast/zipCode/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=1B17AB8C-8D34-4905-88E3-577114AB2097")
		...
		elif api[0]['Category']['Name'] == "Unhealthy(Sensitive Groups)": 
		...
		api_request = requests.get("https://www.airnowapi.org/aq/forecast/zipCode/?format=application/json&zipCode=94404&date=2020-11-07&distance=5&API_KEY=1B17AB8C-8D34-4905-88E3-577114AB2097")
